        ...
        <section class="main-container__item_left-column__item content-section content-section_values">
            ...
            <form class="input-form" action="/web-lab2" method="POST">
                ...
                <div class="input-form__container input-form__container_select">
                    ...
                    <input class="input-form__radio"type="radio" name="xval"  value="-5">-5
                    <input class="input-form__radio" type="radio" name="xval"  value="-4">-4
                    <input class="input-form__radio"  type="radio" name="xval"  value="-3">-3
                    <input class="input-form__radio" type="button" name="xval"  value="-2">-2</input>
                        <input class="input-form__radio" type="button" name="xval"  value="-1">-1</input>
                        <button class="input-form__radio" type="button" name="xval"  value="0" >0</button>
                        <button class="input-form__radio" type="button" name="xval"  value="1">1</button>
                        <button class="input-form__radio" type="button" name="xval"  value="2">2</button>
                ...
                <input class="input-form__hidden_x" type="hidden" name="xval1" value="">
